...
const s = {
  ...
  headerLogoWrap: { flexShrink: 0, backgroundColor: "#b81818", borderRadius: 4, padding: 2 },
 hheaderLogo: { height: 72, width: "auto", display: "block", filter: "drop-shadow(0 0 8px rgba(255,107,53,0.5))", animation: "neonPulse 3s ease-in-out infinite" },
