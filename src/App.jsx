...
const s = {
 ...
 headerLogo: { height: 72, width: "auto", display: "block", filter: "drop-shadow(0 0 8px rgba(255,107,53,0.5))", animation: "neonPulse 3s ease-in-out infinite", backgroundColor: "#a01010", padding: 2 },
